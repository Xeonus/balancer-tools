...
export function calculatePIFromAssetArray(assetArray, sellToken, sellTokenQuantity, buyToken, SwapFee) {
    ...
    let effectivePrice = Number(((1-swapFee)) * sellTokenQuantity / (tokenOutBalance * (1 - ((tokenInBalance / (tokenInBalance + (((1-swapFee)) * sellTokenQuantity)))**(tokenInWeight/tokenOutWeight)))));
