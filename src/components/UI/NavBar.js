...
export default function NavBar(props) {
    ...
    return (
        <div>
            <Button color="primary" className={location.pathname === '/impermanentLoss' ? props.classes.navButton : null} component={NavLink} to={'/impermanentLoss'}>Impermantent Loss</Button>
